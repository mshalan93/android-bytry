package com.example.bytar.ui.newslider;
...
public class NewSlider extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_slider);
    ...
    private void getdata() {
        ...
        call.enqueue(new Callback<List<MySliderList>>() {
            ...
            public void onResponse(Call<List<MySliderList>> call, Response<List<MySliderList>> response) {
                ...
                adapter=new MySliderAdapter(NewSlider.this,mySliderLists,viewPager);
